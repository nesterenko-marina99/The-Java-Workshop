...
public class SummerHighs {
    ...
    public void addSummerHigh(SummerHigh summerHigh) {
        ...
        data.put(baseCity.getName().toLowerCase(), baseCity.getCountry().toLowerCase(),
                summerHigh);
    }

    public SummerHigh createSummerHigh(City baseCity, City noCuts, City moderateCuts) {
        return new SummerHigh(baseCity, noCuts, moderateCuts);
    }

    public City createCity(String name, String country, double temp) {
        return new City(name, country, temp);
    }
